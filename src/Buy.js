    ...
    <div>
      <div className="instant">
        <div className="instant-box">
          <p className=" display-6">Buy/Sell Instantly</p>
          <div>
            <button className="individual">Buy</button>
            <Link className=" btn business" to="/sell">
              Sell
            </Link>
          </div>
          <label htmlFor="Coin to Buy" />
          <select className="buy-page buy">
          ...
          <select className="buy-page buy">
            <option value="Bitcoin (BTC)">300000000</option>
            <option value="USDT/NGN">USDT/NGN</option>
            <option value="ETH">ETH</option>
            <option value="ROKU">ROKU</option>
          </select>
